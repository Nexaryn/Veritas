...
<details>
<summary><b>🖼️ Click to View Screenshots (3 images)</b></summary>

<br>

### Home Page - Dark Theme
![Home Page Light](screenshots/home-page-dark.png)
*Clean and intuitive interface for news analysis*

### Results Page - Example 1 (Dark Theme)
![Result Page 1 Dark](screenshots/result-real-dark.png)
*Real news detection with ensemble voting in dark mode*

### Results Page - Example 3 (Dark Theme)
![Result Page 3 Dark](screenshots/result-fake-dark.png)
